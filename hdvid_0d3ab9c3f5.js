...
async function pollJob(jobId, interval = 5000, maxAttempts = 20) {
...
async function luKontol(video, resolution = '4k') {
...
async function vidEnchancer(video, resolution = '4k') {
  while (true) {
    try {
      return await luKontol(video, resolution)
    } catch (e) {
      if (
        e.code === 'ECONNRESET' ||
