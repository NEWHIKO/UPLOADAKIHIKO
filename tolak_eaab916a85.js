    ...
    case 'tolak': 'menu'; {
      ...
      if (target === m.sender) {
        return sendWithTemplate(
          ...
          decorate(`*❌ Tidak Bisa!*
│
│ Kamu tidak bisa menolak ajakan dari diri sendiri.`),
          { mentions: [m.sender] }
        )
      }
...
│ Pastikan orang tersebut sudah menembak kamu dulu.`),
      ...
      global.db.data.users[target].pasangan = ''

      return sendWithTemplate(
        dino, m,
        decorate(`*💔 Ajakan Ditolak*
│
│ Kamu telah menolak ajakan berpacaran dari @${target.split('@')[0]}.
│
